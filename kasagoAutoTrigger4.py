...
def main():
    ...
    #処理
            ...
            ProcessedFrame=Processing.roiMask(ProcessedFrame,roiX,roiY,roiRad)
...
class autoTrigger:
    ...
    def roiMask(self,Processedframe:list,x:int,y:int,radius:int):
        #GrayScale
        ...
        # 出力用にuint8型に変換
        #maskedFrame=maskedFrame.astype(np.uint8)
            
        #cv2.circle(frameNative,center=(x,y), radius=radius, color=(0,255,0), thickness=3)
